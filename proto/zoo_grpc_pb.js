...
var zoo_pb = require('./zoo_pb.js');

function serialize_zoo_GetBirdByNameRequest(arg) {
  if (!(arg instanceof zoo_pb.GetBirdByNameRequest)) {
...
function deserialize_zoo_GetBirdByNameRequest(buffer_arg) {
  return zoo_pb.GetBirdByNameRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_zoo_GetBirdByNameResponse(arg) {
  if (!(arg instanceof zoo_pb.GetBirdByNameResponse)) {
...
function deserialize_zoo_GetBirdByNameResponse(buffer_arg) {
  return zoo_pb.GetBirdByNameResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_zoo_GetBirdByWingspanRequest(arg) {
  if (!(arg instanceof zoo_pb.GetBirdByWingspanRequest)) {
...
function deserialize_zoo_GetBirdByWingspanRequest(buffer_arg) {
  return zoo_pb.GetBirdByWingspanRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_zoo_GetBirdByWingspanResponse(arg) {
  if (!(arg instanceof zoo_pb.GetBirdByWingspanResponse)) {
...
function deserialize_zoo_GetBirdByWingspanResponse(buffer_arg) {
  return zoo_pb.GetBirdByWingspanResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_zoo_GetBirdsRequest(arg) {
  if (!(arg instanceof zoo_pb.GetBirdsRequest)) {
...
function deserialize_zoo_GetBirdsRequest(buffer_arg) {
  return zoo_pb.GetBirdsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_zoo_GetBirdsResponse(arg) {
  if (!(arg instanceof zoo_pb.GetBirdsResponse)) {
...
function deserialize_zoo_GetBirdsResponse(buffer_arg) {
  return zoo_pb.GetBirdsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ZooService = exports.ZooService = {
  getBirdByName: {
    ...
    requestType: zoo_pb.GetBirdByNameRequest,
    responseType: zoo_pb.GetBirdByNameResponse,
  ...
  getBirdByWingspan: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: zoo_pb.GetBirdByWingspanRequest,
    responseType: zoo_pb.GetBirdByWingspanResponse,
  ...
  getBirds: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: zoo_pb.GetBirdsRequest,
    responseType: zoo_pb.GetBirdsResponse,
